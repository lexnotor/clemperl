...
// Elle n'est PAS gardée, et c'est délibéré : elle sert à constater qu'une session
// ouverte sur la boutique vaut ici, ce que la suite bout en bout vérifie sur les trois
// fronts. L'administration elle-même vit sous `/applications`, derrière la garde.
export default async function HomePage(): Promise<JSX.Element> {
    ...
    return (
        <main className="mx-auto max-w-3xl px-6 py-20">
            ...
            <Link href="/applications" className="mt-8 inline-block text-base underline underline-offset-4">
                {messages.applications.title}
            </Link>
        </main>
    );
}
